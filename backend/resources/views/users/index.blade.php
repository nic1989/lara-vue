            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        ...
                        {!! Form::open(['id' => 'modulesearch', 'method' => 'Get', 'class' => 'form-horizontal mt-3', 'route' => ['user.index']]) !!}
                            <div class="row">
                                ...
                                @if(count($users) > 0)
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                @can('user-edit')
                                                    <a class="mr-1" title="Edit" href="{{ route('user.edit', $user) }}"><i class="fa fa-edit"></i></a>
                                                @endcan
                                                @can('user-delete')
                                                    {!! Form::open(['method' => 'DELETE','route' => ['user.destroy', $user],'style'=>'display:inline']) !!}
                                                        <a title="Delete" href="javascript:void(0)" onclick="confirm('{{ __("Are you sure you want to delete this user?") }}') ? this.parentElement.submit() : ''">
